...
export default function Sidebar({
  ...
  return (
    <div className="w-80 bg-gradient-to-b from-blue-600 to-blue-700 text-white flex flex-col h-screen shadow-2xl">
      <div className="p-6 border-b border-white/10">
        ...
        <button
          onClick={onNewChat}
          className="w-full bg-white hover:bg-blue-50 text-blue-600 font-bold py-3 px-4 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2"
        >
